#############################################################################
# Makefile for building: FaceFinder
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  FaceFinder.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile FaceFinder.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/local/include/opencv -I/usr/local/include/opencv2 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /usr/local/lib/libopencv_calib3d.so /usr/local/lib/libopencv_nonfree.so /usr/local/lib/libopencv_contrib.so /usr/local/lib/libopencv_objdetect.so /usr/local/lib/libopencv_core.so /usr/local/lib/libopencv_ocl.so /usr/local/lib/libopencv_features2d.so /usr/local/lib/libopencv_photo.so /usr/local/lib/libopencv_flann.so /usr/local/lib/libopencv_stitching.so /usr/local/lib/libopencv_gpu.so /usr/local/lib/libopencv_superres.so /usr/local/lib/libopencv_highgui.so /usr/local/lib/libopencv_video.so /usr/local/lib/libopencv_imgproc.so /usr/local/lib/libopencv_videostab.so /usr/local/lib/libopencv_legacy.so -lQt5Widgets -L/usr/lib/x86_64-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: FaceFinder.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile FaceFinder.pro
...
dist: 
	@test -d .tmp/FaceFinder1.0.0 || mkdir -p .tmp/FaceFinder1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/FaceFinder1.0.0/ && $(COPY_FILE) --parents mainwindow.h VideoProcessor.hpp FaceDetection.hpp FGSegmentation.hpp .tmp/FaceFinder1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/FaceFinder1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/FaceFinder1.0.0/ && (cd `dirname .tmp/FaceFinder1.0.0` && $(TAR) FaceFinder1.0.0.tar FaceFinder1.0.0 && $(COMPRESS) FaceFinder1.0.0.tar) && $(MOVE) `dirname .tmp/FaceFinder1.0.0`/FaceFinder1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/FaceFinder1.0.0
